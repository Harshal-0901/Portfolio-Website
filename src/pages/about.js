...
import ProfilePic from "../../public/images/profile/about-section-image.jpeg"
...
const about = () => {
  return (
    <>
      <Head>
        <title>Harshal Presswala | About Page</title>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I'm Harshal Presswala, a full stack web developer with a
                passion for creating beautiful, functional, and user-centered
                digital experiences. I am also proficient in Data Structures and
                Algorithms (DSA) with a strong grasp on problem-solving and
                algorithmic thinking, applied in various programming scenarios.
              ...
              <p className="font-medium">
                Whether I'm working on a website or any other digital product, I
