    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="mailto:harshalpresswala09@gmail.com"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
      ...
      bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 xs:w-[90%]"
        >
      ...
      <div className="flex justify-center lg:justify-start absolute top-2 left-1/2 transform -translate-x-1/2">
        <Logo />
      </div>
    </header>
  );
